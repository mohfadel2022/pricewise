                ...
                <div className="flex gap-3">
                  <div className="product-stars">
                    <Image
                      ...
                      height={16}
                    />
                    <p className="text-md text-primary-orange font-semibold">{product.stars || '25'} </p>
                  </div>
                  <div className="product-reviews">
                    <Image
                      ...
                      height={16}
                    />
                    <p className="text-md text-secondary font-semibold">{product.reviewsCount} reviews </p>
                  </div>
                </div>
